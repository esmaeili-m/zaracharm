...
(() => {
  ...
  if (
    !localStorage.getItem("yzenlayout") &&
    !localStorage.getItem("yzennavstyles") &&
    !localStorage.getItem("yzenverticalstyles") &&
  ...
  function rtlFn() {
    ...
    document
      ...
      ?.setAttribute(
        "href",
        "/libs/bootstrap/css/bootstrap.rtl.min.css"
      );
    //RTL
      ...
      switch (verticalStyle) {
        ...
        case "overlay":
          ...
          if (html.getAttribute("data-toggled") === "icon-overlay-close") {
            ...
            if (window.innerWidth >= 992) {
              if (!localStorage.getItem("yzenlayout")) {
