...
function switcherClick() {
    ...
    let backgroundColor1Var = bgDefaultColor1Btn.addEventListener('click', () => {
        localStorage.setItem('bodyBgRGB', "0, 71, 114");
        localStorage.setItem('bodylightRGB', "14, 85, 128");
        ...
        document.querySelector('html').style.setProperty('--light-rgb', "14, 85, 128");
        document.querySelector('html').style.setProperty('--form-control-bg', "rgb(14, 85, 128)");
    ...
    let backgroundColor2Var = bgDefaultColor2Btn.addEventListener('click', () => {
        localStorage.setItem('bodyBgRGB', "84, 32, 0");
        localStorage.setItem('bodylightRGB', "98, 46, 14");
        html.setAttribute('data-theme-mode', 'dark');
        html.setAttribute('data-menu-styles', 'dark');
        html.setAttribute('data-header-styles', 'dark');
        document.querySelector('html').style.setProperty('--body-bg-rgb', localStorage.bodyBgRGB);
        document.querySelector('html').style.setProperty('--body-bg-rgb2', localStorage.bodylightRGB);
        document.querySelector('html').style.setProperty('--light-rgb', "98, 46, 14");
        document.querySelector('html').style.setProperty('--form-control-bg', "rgb(98, 46, 14)");
        document.querySelector('html').style.setProperty('--input-border', "rgba(255,255,255,0.1)");
        document.querySelector('html').style.setProperty('--gray-3', "rgba(255,255,255,0.1)");
        document.querySelector('#switcher-dark-theme').checked = true;
        document.querySelector('#switcher-menu-dark').checked = true;
    ...
    let backgroundColor3Var = bgDefaultColor3Btn.addEventListener('click', () => {
        localStorage.setItem('bodyBgRGB', "102, 0, 111");
        localStorage.setItem('bodylightRGB', "116, 14, 125");
        html.setAttribute('data-theme-mode', 'dark');
        html.setAttribute('data-menu-styles', 'dark');
        html.setAttribute('data-header-styles', 'dark');
        document.querySelector('html').style.setProperty('--body-bg-rgb', localStorage.bodyBgRGB);
        document.querySelector('html').style.setProperty('--body-bg-rgb2', localStorage.bodylightRGB);
        document.querySelector('html').style.setProperty('--light-rgb', "116, 14, 125");
        document.querySelector('html').style.setProperty('--form-control-bg', "rgb(116, 14, 125)");
        document.querySelector('html').style.setProperty('--input-border', "rgba(255,255,255,0.1)");
        document.querySelector('html').style.setProperty('--gray-3', "rgba(255,255,255,0.1)");
        document.querySelector('#switcher-dark-theme').checked = true;
        document.querySelector('#switcher-menu-dark').checked = true;
    ...
    let backgroundColor4Var = bgDefaultColor4Btn.addEventListener('click', () => {
        localStorage.setItem('bodyBgRGB', "58, 67, 0");
        localStorage.setItem('bodylightRGB', "72, 81, 14");
        html.setAttribute('data-theme-mode', 'dark');
        html.setAttribute('data-menu-styles', 'dark');
        html.setAttribute('data-header-styles', 'dark');
        document.querySelector('html').style.setProperty('--body-bg-rgb', localStorage.bodyBgRGB);
        document.querySelector('html').style.setProperty('--body-bg-rgb2', localStorage.bodylightRGB);
        document.querySelector('html').style.setProperty('--light-rgb', "72, 81, 14");
        document.querySelector('html').style.setProperty('--form-control-bg', "rgb(72, 81, 14)");
        document.querySelector('html').style.setProperty('--input-border', "rgba(255,255,255,0.1)");
        document.querySelector('html').style.setProperty('--gray-3', "rgba(255,255,255,0.1)");
        document.querySelector('#switcher-dark-theme').checked = true;
        document.querySelector('#switcher-menu-dark').checked = true;
    ...
    let backgroundColor5Var = bgDefaultColor5Btn.addEventListener('click', () => {
        localStorage.setItem('bodyBgRGB', "71, 0, 82");
        localStorage.setItem('bodylightRGB', "85, 14, 96");
        html.setAttribute('data-theme-mode', 'dark');
        html.setAttribute('data-menu-styles', 'dark');
        html.setAttribute('data-header-styles', 'dark');
        document.querySelector('html').style.setProperty('--body-bg-rgb', localStorage.bodyBgRGB);
        document.querySelector('html').style.setProperty('--body-bg-rgb2', localStorage.bodylightRGB);
        document.querySelector('html').style.setProperty('--light-rgb', "85, 14, 96");
        document.querySelector('html').style.setProperty('--form-control-bg', "rgb(85, 14, 96)");
        document.querySelector('html').style.setProperty('--input-border', "rgba(255,255,255,0.1)");
        document.querySelector('html').style.setProperty('--gray-3', "rgba(255,255,255,0.1)");
        document.querySelector('#switcher-dark-theme').checked = true;
        document.querySelector('#switcher-menu-dark').checked = true;
    ...
    let darkThemeVar = darkBtn.addEventListener('click', () => {
        darkFn();
        localStorage.setItem("yzenMenu", 'dark');
        localStorage.setItem("yzenHeader", 'transparent');
        if (html.getAttribute('data-nav-layout') === 'horizontal') {
            html.setAttribute('data-header-styles', 'dark');
        }
    });
    ...
    let colorMenuVar = colorMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("yzenMenu", 'color');
    });
    /* Color Menu End */
    ...
    let gradientMenuVar = gradientMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("yzenMenu", 'gradient');
    });
    /* Gradient Menu End */
    ...
    let transparentMenuVar = transparentMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("yzenMenu", 'transparent');
    });
    ...
    let colorHeaderVar = colorHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("yzenHeader", 'color');
    });
    /* Color Header End */
    ...
    let gradientHeaderVar = gradientHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("yzenHeader", 'gradient');
    });
    /* Gradient Header End */
    ...
    let defaultwidthVar = defaultwidthBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("yzendefaultwidth", true);
        localStorage.removeItem("yzenboxed");
        localStorage.removeItem("yzenfullwidth");
    });
    ...
    let fullwidthVar = fullwidthBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("yzenfullwidth", true);
        localStorage.removeItem("yzenboxed");
        localStorage.removeItem("yzendefaultwidth");
    });
    ...
    let boxedVar = boxedBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("yzenboxed", true);
        localStorage.removeItem("yzenfullwidth");
        localStorage.removeItem("yzendefaultwidth");
        checkHoriMenu()
    });
    ...
    let shadowVar = regular.addEventListener('click', () => {
        ...
        localStorage.setItem("yzenregular", true);
        localStorage.removeItem("yzenclassic");
        localStorage.removeItem("yzenmodern");
    });
    ...
    let noShadowVar = classic.addEventListener('click', () => {
        ...
        localStorage.setItem("yzenclassic", true);
        localStorage.removeItem("yzenregular");
        localStorage.removeItem("yzenmodern");
    });
    ...
    let modernVar = modern.addEventListener('click', () => {
        ...
        localStorage.setItem("yzenmodern", true);
        localStorage.removeItem("yzenregular");
        localStorage.removeItem("yzenclassic");
    });
    ...
    let fixedHeaderVar = fixedHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("yzenheaderfixed", true);
        localStorage.removeItem("yzenheaderscrollable");
    });

    let scrollHeaderVar = scrollHeaderBtn.addEventListener('click', () => {
        html.setAttribute('data-header-position', 'scrollable');
        localStorage.setItem("yzenheaderscrollable", true);
        localStorage.removeItem("yzenheaderfixed");
    });
    ...
    let fixedMenuVar = fixedMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("yzenmenufixed", true);
        localStorage.removeItem("yzenmenuscrollable");
    });

    let scrollMenuVar = scrollMenuBtn.addEventListener('click', () => {
        html.setAttribute('data-menu-position', 'scrollable');
        localStorage.setItem("yzenmenuscrollable", true);
        localStorage.removeItem("yzenmenufixed");
    });
    ...
    let closedVar = closedBtn.addEventListener('click', () => {
        closedSidemenuFn();
        localStorage.setItem("yzenverticalstyles", 'closed');
        document.querySelectorAll(".main-menu>li.open").forEach((ele) => {
            if (!ele.classList.contains('active')) {
                ele.classList.remove('open')
                ele.querySelector('ul').style.display = 'none'
    ...
    let detachedVar = detachedBtn.addEventListener('click', () => {
        detachedFn();
        localStorage.setItem("yzenverticalstyles", 'detached');
    });
    /* Hover Submenu End */
    ...
    let iconTextVar = iconTextBtn.addEventListener('click', () => {
        iconTextFn();
        localStorage.setItem("yzenverticalstyles", 'icontext');
    });
    ...
    let overlayVar = overlayBtn.addEventListener('click', () => {
        iconOverayFn();
        localStorage.setItem("yzenverticalstyles", 'overlay');
        document.querySelectorAll(".main-menu>li.open").forEach((ele) => {
            if (!ele.classList.contains('active')) {
                ele.classList.remove('open')
                ele.querySelector('ul').style.display = 'none'
    ...
    let doubleVar = doubleBtn.addEventListener('click', () => {
        doubletFn();
        localStorage.setItem("yzenverticalstyles", 'doublemenu');
    });
    ...
    let menuClickVar = menuClickBtn.addEventListener('click', () => {
        ...
        menuClickFn();
        localStorage.setItem("yzennavstyles", 'menu-click');
        localStorage.removeItem("yzenverticalstyles");
        document.querySelectorAll(".main-menu>li.open").forEach((ele) => {
            if (!ele.classList.contains('active')) {
                ele.classList.remove('open')
    ...
    let menuhoverVar = menuHoverBtn.addEventListener('click', () => {
        html.removeAttribute('data-vertical-style');
        menuhoverFn();
        localStorage.setItem("yzennavstyles", 'menu-hover');
        localStorage.removeItem("yzenverticalstyles");
    ...
    let iconClickVar = iconClickBtn.addEventListener('click', () => {
        html.removeAttribute('data-vertical-style');
        iconClickFn();
        localStorage.setItem("yzennavstyles", 'icon-click');
        localStorage.removeItem("yzenverticalstyles");
    ...
    let iconhoverVar = iconHoverBtn.addEventListener('click', () => {
        html.removeAttribute('data-vertical-style');
        iconHoverFn();
        localStorage.setItem("yzennavstyles", 'icon-hover');
        localStorage.removeItem("yzenverticalstyles");
    ...
    let verticalVar = verticalBtn.addEventListener('click', () => {
        ...
        // local storage
        localStorage.removeItem("yzenlayout");
        localStorage.setItem("yzenverticalstyles", 'default');
        verticalFn();
        setNavActive();
    ...
    let horiVar = horiBtn.addEventListener('click', () => {
        ...
        html.removeAttribute('data-vertical-style');
        //    local storage
        localStorage.setItem("yzenlayout", 'horizontal');
        localStorage.removeItem("yzenverticalstyles");
...
function rtlFn() {
    ...
    const baseUrl = document.querySelector('base')?.getAttribute('href') || '/';
    document.querySelector("#style")?.setAttribute("href", baseUrl + "dashboard/libs/bootstrap/css/bootstrap.rtl.min.css");
...
function lightFn() {
    ...
    localStorage.removeItem("yzenbgColor");
    localStorage.removeItem("yzenheaderbg");
    localStorage.removeItem("yzenbgwhite");
    checkOptions();
...
function horizontalClickFn() {
    ...
    if (html.getAttribute('data-nav-layout') === 'horizontal' && !localStorage.yzenHeader) {
        if (html.getAttribute('data-theme-mode') === 'light') {
            html.setAttribute('data-header-styles', 'light');
        } else if (html.getAttribute('data-theme-mode') === 'dark') {
            html.setAttribute('data-header-styles', 'dark');
    ...
    if (!localStorage.yzenMenu && !localStorage.bodylightRGB) {
        html.setAttribute("data-menu-styles", "light")
...
function checkOptions() {
    ...
    if (localStorage.getItem('yzenltr')) {
    ...
    // light header
    if (localStorage.getItem('yzenHeader') === "light") {
        document.querySelector('#switcher-header-light').checked = true;
    }

    // color header
    if (localStorage.getItem('yzenHeader') === "color") {
        document.querySelector('#switcher-header-primary').checked = true;
    }

    // gradient header
    if (localStorage.getItem('yzenHeader') === "gradient") {
        document.querySelector('#switcher-header-gradient').checked = true;
    }

    // dark header
    if (localStorage.getItem('yzenHeader') === "dark") {
        document.querySelector('#switcher-header-dark').checked = true;
    }
    // transparent header
    if (localStorage.getItem('yzenHeader') === "transparent") {
    ...
    // color menu
    if (localStorage.getItem('yzenMenu') === 'color') {
        document.querySelector('#switcher-menu-primary').checked = true;
    }

    // gradient menu
    if (localStorage.getItem('yzenMenu') === 'gradient') {
        document.querySelector('#switcher-menu-gradient').checked = true;
    }

    // dark menu
    if (localStorage.getItem('yzenMenu') === 'dark') {
        document.querySelector('#switcher-menu-dark').checked = true;
    }
    // transparent menu
    if (localStorage.getItem('yzenMenu') === 'transparent') {
        document.querySelector('#switcher-menu-transparent').checked = true;
    }

    //default width
    if (localStorage.getItem('yzendefaultwidth')) {
        document.querySelector('#switcher-default-width').checked = true;
    }

    //full width
    if (localStorage.getItem('yzenfullwidth')) {
        document.querySelector('#switcher-full-width').checked = true;
    }

    //boxed
    if (localStorage.getItem('yzenboxed')) {
        document.querySelector('#switcher-boxed').checked = true;
    }

    //scrollable
    if (localStorage.getItem('yzenheaderscrollable')) {
        document.querySelector('#switcher-header-scroll').checked = true;
    }
    if (localStorage.getItem('yzenmenuscrollable')) {
        document.querySelector('#switcher-menu-scroll').checked = true;
    }

    //fixed
    if (localStorage.getItem('yzenheaderfixed')) {
        document.querySelector('#switcher-header-fixed').checked = true;
    }
    if (localStorage.getItem('yzenmenufixed')) {
        document.querySelector('#switcher-menu-fixed').checked = true;
    }

    //classic
    if (localStorage.getItem('yzenclassic')) {
        document.querySelector('#switcher-classic').checked = true;
    }

    //modern
    if (localStorage.getItem('yzenmodern')) {
