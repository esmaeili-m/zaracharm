...
new class extends Component
{
    ...
    public function mount(Slider $model)
    {
        ...
        $this->info['delete']='حذف اسلایدر';
        $this->info['personal']='اسلایدر';
    ...
    public function messages()
    {
        return [
            ...
            // title
            'title.required' => 'وارد کردن نام اسلایدر الزامی است.',
            'title.string'   => 'نام اسلایدر باید متن باشد.',
            'title.min'      => 'نام اسلایدر باید حداقل ۲ کاراکتر باشد.',
            'title.max'      => 'نام اسلایدر نباید بیشتر از ۲۰۰ کاراکتر باشد.',
