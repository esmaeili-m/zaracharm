...
new class extends Component
{
    ...
    public function mount(Article $model)
    {
        ...
        $this->model=$model;
        $this->info['header']='لیست مقالات';
        $this->info['create']='افزودن مقاله';
        $this->info['delete']='حذف مقاله';
        $this->info['personal']='مقاله';
    ...
    public function messages(): array
    {
        return [
            ...
            'title.string' => 'عنوان مقاله معتبر نیست.',
            ...
            'description.required' => 'متن مقاله الزامی است.',
            'description.string' => 'متن مقاله معتبر نیست.',
    ...
    {
        abort_if(!auth()->user()->can('articles.create'), 403);
...
<div>
    <div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
        ...
        <div class="btn-list">
            ...
            <a href="{{route('articles.trash')}}" class="btn btn-warning-light btn-wave me-2">
