...
new class extends Component
{
    ...
    {
        $this->model=$model;
        $this->info['header']='لیست کاربران حذف شده';
        $this->info['list']='لیست کاربر';
        $this->info['delete']='حذف کاربر';
        $this->info['restore']='بازگردانی کاربر';
...
<div>
    <div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
        ...
        <div class="btn-list">
            <a href="{{route('users.index')}}" class="btn btn-warning-light btn-wave me-2">
