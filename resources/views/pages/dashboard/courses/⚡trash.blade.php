...
new class extends Component
{
    ...
    {
        $this->model=$model;
        $this->info['header']='لیست دوره های حذف شده';
        $this->info['list']='لیست دوره ها';
        $this->info['delete']='حذف دوره';
        $this->info['restore']='بازگردانی دوره';
...
<div>
    <div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
        ...
        <div class="btn-list">
            <a href="{{route('courses.index')}}" class="btn btn-warning-light btn-wave me-2">
