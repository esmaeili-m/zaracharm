...
new class extends Component
{
    ...
    public ?Specification $selectItem = null;
    public int $type = 1;
    ...
    public function mount(Specification $model)
    {
        abort_if(!auth()->user()->can('categories.view'), 403);
        $this->model=$model;
        $this->info['header']='لیست مشخصه فنی ها';
        $this->info['create']='افزودن مشخصه فنی';
        $this->info['delete']='حذف مشخصه فنی';
        $this->info['personal']='مشخصه فنی';
    ...
    public function rules()
    {
        ...
        return [
            ...
            'slug' => [
                ...
                'max:200',
                'regex:/^[a-zA-Z0-9\-_]+$/',
                Rule::unique('specifications', 'slug')->ignore($id),
            ],
    ...
    public function messages()
    {
        return [
            ...
            // title
            'title.required' => 'وارد کردن عنوان مشخصه الزامی است.',
            'title.string'   => 'عنوان مشخصه باید متن باشد.',
            'title.min'      => 'عنوان مشخصه باید حداقل ۲ کاراکتر باشد.',
            'title.max'      => 'عنوان مشخصه نباید بیشتر از ۲۰۰ کاراکتر باشد.',
            ...
            // type
            'type.required' => 'انتخاب نوع داده الزامی است.',
            'type.integer'  => 'نوع داده معتبر نیست.',
            'type.in'       => 'نوع داده انتخاب شده معتبر نیست.',

            // sort
            'sort.integer' => 'ترتیب نمایش باید یک عدد باشد.',
            'sort.min'     => 'ترتیب نمایش نمی‌تواند منفی باشد.',

            // boolean
            'is_filterable.boolean' => 'وضعیت فیلترپذیری معتبر نیست.',
            'is_visible.boolean'    => 'وضعیت نمایش معتبر نیست.',
            'status.boolean'        => 'وضعیت فعال بودن معتبر نیست.',
    ...
    <div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
        ...
        <div class="btn-list">
            @can('categories.view')
                ...
                <a href="{{route('specifications.trash')}}" class="btn btn-warning-light btn-wave me-2">
