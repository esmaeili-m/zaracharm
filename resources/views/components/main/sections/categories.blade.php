...
{
    public $articles,$courses;
    public function mount()
    {
       $this->articles =\App\Models\Article::active()->whereNotNull('category_id')->with('category')->withCount('comments')->get();
       $this->courses =\App\Models\Course::active()->whereNotNull('category_id')->with(['media', 'category'])->withCount([
               'sections',
               'lessons',
               'likes',
               'comments'
                ...
                <div class="container">
                    <div class="error-page__inner text-center">
                        ...
                        <div class="error-page__content">
                            ...
                            <p>صفحه‌ای که به دنبال آن هستید وجود ندارد. ممکن است منتقل یا حذف شده باشد.</p>
                            <div class="btn-box">
                                <a class="thm-btn" href="index.html"> <span class="far fa-angle-double-left"></span> بازگشت به صفحه اصلی</a>
                            </div>
                        </div>
                    </div>
                </div>
